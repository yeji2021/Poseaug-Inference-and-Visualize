...
from common.mocap_dataset_edit import MocapDataset
from common.camera import normalize_screen_coordinates, image_coordinates
from common.h36m_dataset import h36m_skeleton, h36m_skeleton_joints_group
...
custom_camera_params = {
    ...
    # Dummy camera parameters (taken from Hum   an3.6M), only for visualization purposes
...
class CustomDataset(MocapDataset):
    def __init__(self, detections_path, remove_static_joints=True):
        ...
        if remove_static_joints:
            ...
            # add 'Nose' joint to remove_joint
